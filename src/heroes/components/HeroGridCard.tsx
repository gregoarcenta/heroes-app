  ...
  return (
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
      <div className="relative h-64">
        ...
        {/* Universe badge */}
        <Badge
          className={`absolute top-3 right-3 text-xs text-white ${hero.universe === "Marvel" ? "bg-red-600" : "bg-blue-600"}`}
        >
          {hero.universe}
        </Badge>
        ...
        >
          <Heart
            className={`h-4 w-4 ${isFavorite(hero) ? "fill-red-500" : "fill-white"}`}
          />
        </Button>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-medium">Inteligecia</span>
            </div>
            <Progress
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-medium">Velicidad</span>
            </div>
            <Progress
              value={hero.speed * 10}
              className="h-2"
